...
base_ckpt_dir=/mnt/hdd3/xingyouguang/projects/robotics/lerobot/outputs/train/2025-03-30/22-21-37_diffusion/checkpoints
...
min_weight2=0.60
max_weight2=0.60
local_log_dir="./experiments/logs-${min_weight1}-${max_weight1}-${min_weight2}-${max_weight2}-norobot_stat"
