...
base_ckpt_dir=/mnt/hdd3/xingyouguang/projects/robotics/lerobot/outputs/train/2025-04-01/14-35-22_diffusion/checkpoints
...
min_weight1=0.25
max_weight1=0.25
local_log_dir="./experiments/logs-${min_weight1}-${max_weight1}-${min_weight1}-${max_weight1}-noflip-resize"
