...
DATA_MIX="minivla-spatial-split-dataset-400500-500600"
# 判断路径是否存在, LIBERO_DATA_ROOT
LIBERO_DATA_ROOT="/mnt/hdd3/xingyouguang/datasets/robotics/libero/libero_spatial_no_noops_island_split_rlds/xyg_50_02_15.0_65.0"
...
LOG_ROOT=libero_qwen_pretrain_split
WANDB_PROJECT="libero_qwen_split"
