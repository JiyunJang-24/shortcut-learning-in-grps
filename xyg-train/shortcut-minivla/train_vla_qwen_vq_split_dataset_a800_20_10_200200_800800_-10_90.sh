#!/bin/bash
#SBATCH -J 200200-800800-large-20x10-minivla-xyg
#SBATCH -p gpu
#SBATCH -N 1 # <一个节点>
...
#SBATCH --exclude=gn[001,002,003,004,005,010,011,053] # 排除哪些节点
...
DATA_MIX="minivla-spatial-split-dataset-200200-800800"
