...
python experiments/robot/libero/regenerate_libero_lerobot_island_dataset_repeat.py \
...
def main(args):
    ...
    user_name = f"{args.user_name}_{viewpoint_rotate_upper_bound}_{viewpoint_rotate_lower_bound}"
