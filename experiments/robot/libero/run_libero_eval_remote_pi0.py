...
Usage:
    ...
    python experiments/robot/libero/run_libero_eval_remote_pi0.py \
...
python experiments/robot/libero/run_libero_eval_remote_pi0.py \
    ...
    --center_crop False \
    --run_id_note "pi0_fast_libero_90_test" \
    --use_wandb False \
    --need_all_flipped True
...
python experiments/robot/libero/run_libero_eval_remote_pi0.py \
    ...
    --num_trials_per_task 5 \
    --center_crop False \
    --run_id_note "pi0_libero_90_test" \
    --use_wandb False \
    --need_all_flipped True
"""
...
class GenerateConfig:
    ...
    # pi0 or pi0_fast server
    server_host: str = "localhost"
    server_port: int = 8000
    replan_steps: int = 5
    need_all_flipped: bool = False
...
def eval_libero(cfg: GenerateConfig) -> None:
    ...
    # Load model
    model = get_model(cfg)
    if model is None and cfg.model_family in ["pi0", "pi0_fast"]:
        model = websocket_client_policy.WebsocketClientPolicy(host=cfg.server_host, port=cfg.server_port)
            ...
            while t < max_steps + cfg.num_steps_wait:
                try:
                    ...
                    if cfg.model_family in ["openvla", "prismatic"]:
                        ...
                        assert cfg.use_wrist_image
                        
                        if cfg.need_all_flipped:
                        ...
                        raise ValueError("Unexpected model family: {}".format(cfg.model_family))
