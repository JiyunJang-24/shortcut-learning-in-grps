...
for i in "${viewpoint_rotate[@]}"; do
    ...
    if [ 1 -eq 1 ]; then
        python experiments/robot/libero/regenerate_libero_hdf5_lerobot_dataset_repeat_split_with_cam_info_cross_embodiment.py \
            ...
            --demo_repeat_times $demo_repeat_times --change_light False --robot "UR5e" --gripper_type "default"
    fi
