...
base_ckpt_dir=logs/2025-4-15/9-46-7_libero_qwen_pretrain_test2/prism-qwen25-dinosiglip-224px+0_5b+mx-libero-90+n0+b12+x7/checkpoints
...
local_log_dir="./experiments-test/logs-50-01-${min_weight1}-${max_weight1}-${task1_id}-${min_weight2}-${max_weight2}-${task2_id}"
