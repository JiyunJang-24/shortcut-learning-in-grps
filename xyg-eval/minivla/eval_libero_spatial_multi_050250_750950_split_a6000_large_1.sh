...
base_ckpt_dir=logs/2025-4-22/2-43-51_libero_minivla_split_large_distance/prism-qwen25-dinosiglip-224px+0_5b+mx-libero-90+n1+b16+x7/checkpoints
...
function get_single_weight() {
    ...
    if [ "${x}" == "A" ]; then
        ...
        cur_weight_min=0.250
        cur_weight_max=0.250
    elif [ "${x}" == "B" ]; then
        ...
        cur_weight_min=0.750
        cur_weight_max=0.750
    elif [ "${x}" == "C" ]; then
