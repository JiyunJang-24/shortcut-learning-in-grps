...
base_ckpt_dir=logs/2025-4-21/11-5-41_libero_qwen_pretrain_split_large/prism-qwen25-dinosiglip-224px+0_5b+mx-libero-90+n1+b16+x7/checkpoints
...
function get_single_weight() {
    ...
    if [ "${x}" == "A" ]; then
        ...
        cur_weight_min=0.300
        cur_weight_max=0.300
    elif [ "${x}" == "B" ]; then
        ...
        cur_weight_min=0.700
        cur_weight_max=0.700
    elif [ "${x}" == "C" ]; then
