#!/bin/bash
#SBATCH -J 200200-800800-large-20x10-minivla-eval-xyg
#SBATCH -p gpu
#SBATCH -N 1 # <一个节点>
...
base_ckpt_dir=logs/2025-4-23/23-15-13_libero_minivla_split_large_distance_20_10/prism-qwen25-dinosiglip-224px+0_5b+mx-libero-90+n0+b32+x7/checkpoints
