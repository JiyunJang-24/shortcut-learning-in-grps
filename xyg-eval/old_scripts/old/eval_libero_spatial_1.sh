...
base_ckpt_dir=/mnt/hdd3/xingyouguang/projects/robotics/lerobot/outputs/train/2025-03-29/14-40-23_diffusion/checkpoints
...
min_weight2=0.75
max_weight2=0.75
local_log_dir="./experiments/logs-${min_weight1}-${max_weight1}-${min_weight2}-${max_weight2}"
