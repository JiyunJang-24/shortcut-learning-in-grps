...
base_ckpt_dir=/mnt/hdd3/xingyouguang/projects/robotics/lerobot/outputs/train/2025-04-03/23-20-38_diffusion/checkpoints
...
viewpoint_rotate_upper_bound=15
viewpoint_rotate_lower_bound=65
...
local_log_dir="./experiments-island/logs-${min_weight1}-${max_weight1}-${task1_id}-${min_weight2}-${max_weight2}-${task2_id}-dense-${delta_shift}"
