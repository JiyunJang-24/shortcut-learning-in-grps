...
<body>
    ...
    <div class="camera-view">
        <img id="camera-image" src="" alt="Camera View" width="512" height="512">
    </div>
    ...
    # Start Flask server
    print(f"\nStarting camera control interface on http://localhost:5000")
    print(f"To access from VSCode, you may need to setup port forwarding:")
    print(f"1. Click on 'Ports' tab in the terminal panel")
    print(f"2. Click 'Forward a Port' and enter 5000")
    print(f"3. Then access http://localhost:5000 in your local browser\n")
